...
def main():
    p = argparse.ArgumentParser(
        description="Track, center and crop a planetary video for AutoStakkert! 4."
    )
    ...
    p.add_argument("-o", "--output", help="Custom output AVI path")
    ...
    output_path = os.path.abspath(args.output) if args.output else stem + "_centered_AS4.avi"
    ...
    print(f"\nDone: {output_path}")
    print(f"Frames: {written} | ROI: {roi_w}x{roi_h} | Format: raw RGB24 AVI")
